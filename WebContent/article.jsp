...
font-size: 16px;"> <div class="username">
        ...
        <div id="page-wrapper" >
            <div id="page-inner" >
                <div class="row">
                 ...
                 <!-- /. ROW  -->
                <hr />       
                <h2><b><s:property escape="false" value="messageStore.sample_name" /></b>
	...
	<div class="content" >					
			...
			<div  class="minical2"  id="minical2">
                ...
                <!--user_screen-->
                    <div class="col-md-3 col-sm-12 col-xs-12" style="height:440px; width:200px; float:right; margin-top:-1200px; background-color:inherit;">                       
